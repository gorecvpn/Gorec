...
## [4.17.0](https://github.com/gorecvpn/Gorec/compare/v4.16.9...v4.17.0) (2026-09-25)
...
* raffle grants tickets per month of the purchased subscription period (1/3/6/12), with per-campaign toggle ([9ebd809](https://github.com/gorecvpn/Gorec/commit/9ebd809e7807d262c83cb8c6218fbf4a67e999e9))
...
* **raffle:** enhancement pack — auto-draw, notifies, antifraud, promo, referral top-up, CSV (4.16.10) ([7bdd9af](https://github.com/gorecvpn/Gorec/commit/7bdd9af82ccac7045bc30022383b18efc667780a))
...
* admin raffle back button and 🎁 raffle label in admin menu ([df48be0](https://github.com/gorecvpn/Gorec/commit/df48be0bf01747761c433f34227ce0f1f93d16e4))
...
* raffle button uses locale 🎁 label instead of stale 🎫 from saved menu layout ([18ac708](https://github.com/gorecvpn/Gorec/commit/18ac708941688a4dd4c4e62708e9ed2f1019af78))
* **raffle:** CSV path for cabinet + Gift menu emoji (4.16.11) ([44f76eb](https://github.com/gorecvpn/Gorec/commit/44f76eb774a2e50366727297e23eb4b078184a28))
* **raffle:** empty-style labels + force Gift emoji on menu (4.16.12) ([72c40f8](https://github.com/gorecvpn/Gorec/commit/72c40f804400c1377cb370433d1892dc078ced74))
